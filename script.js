...
if (saveDateBtn) {
    ...
    saveDateBtn.addEventListener("click", () => {
        ...
        const title = "Pernikahan Elsa & Farid";
        const location = "Belum ditentukan";
        const details = "Kami mengundang Anda untuk menghadiri pernikahan Elsa & Farid.";
...
formData.append("ucapan", document.getElementById("message").value);
    try {
        ...
        const response = await fetch(
            "https://script.google.com/macros/s/AKfycbyeDV9ehqXyN3UM22ChB_etCCjTcy0zq_6S_IgojPmk_FKW0gy6jmUTma2wHO4HJykr/exec",
            {
                method: "POST",
                body: formData
            }
